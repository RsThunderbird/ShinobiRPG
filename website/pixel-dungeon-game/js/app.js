define(['util/observer', 'util/dom-helper', 'asset-loader', 'scenes/title-scene', 'scenes/about-scene',
  'scenes/badges-scene', 'scenes/rankings-scene', 'scenes/game-scene', 'scenes/hero-selection-scene', 'scenes/forest-scene', 'util/logger'],
  function (Observer, DomHelper, AssetLoader, TitleScene, AboutScene, BadgesScene, RankingsScene, GameScene, HeroSelectionScene, ForestScene, Logger) {
      ...
      changeScene: function (data) {
        ...
        switch (this.state) {
          ...
          case "HERO_SELECTION":
            ...
            break;
          case "FOREST":
            this.currentScene = new ForestScene(sceneOptions)
            break;
          default:
            this.currentScene = null;
        }
